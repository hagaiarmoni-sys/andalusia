...
# These values are based on visible landmarks in the map image:
# - Top-left: ~Estremoz/Badajoz area
# - Bottom-right: ~Cartagena/Alicante area  
# - Bottom: Gibraltar visible
# - The map is wider than it is tall
ANDALUSIA_BOUNDS = {
    "min_lat": 35.8,   # Bottom edge (below Gibraltar)
    "max_lat": 39.0,   # Top edge (above Badajoz)
    "min_lon": -8.0,   # Left edge (west of Huelva/Portugal)
    "max_lon": -0.5    # Right edge (past Cartagena)
}
