...
def main():
    ...
    # routes_data = try_load("andalusia_routes.json")  # Not used
...
def show_preferences():
    ...
    default_prefs = {
        ...
        "default_pace": "medium",
        "max_km_per_day": 300,
        "poi_categories": ["history", "architecture", "museums", "nature", "beaches", "neighborhoods", "viewpoints"],  # ✅ Good default mix
        "hotel_platform": "Any",
        "max_price_per_night": 150,
        "min_poi_rating": 3.5,  # Default: 3.5+ stars (good quality)
